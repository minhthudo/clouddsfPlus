...
var decisionGraph = (function() {
    ...
    var force, node, nodes = [],
        links = [],
        pathGroup, text, circle, path, visGroup;
    var node_lookup = [],
        initialNodes, foci, relations = [];

    // Text for legends (Decision relations)
    ...
    function collide(alpha) {
        ...
        return function(d) {
            var r = d.radius + config.decisionWidth + config.nodePadding,
                nx1 = d.x -
                r,
                nx2 = d.x + r,
                ny1 = d.y - r,
